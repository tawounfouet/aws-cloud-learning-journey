...
aws ec2 authorize-security-group-ingress --group-id sg-09d49bfded4fb60e0 --protocol tcp --port 2049 --source-group sg-09d49bfded4fb60e0
4. Launch instance in US-EAST-1A
aws ec2 run-instances --image-id ami-0dfcb1ef8550277af --instance-type t2.micro --placement AvailabilityZone=us-east-1a --security-group-ids sg-09d49bfded4fb60e0
5. Launch instance in US-EAST-1B
aws ec2 run-instances --image-id ami-0dfcb1ef8550277af --instance-type t2.micro --placement AvailabilityZone=us-east-1b --security-group-ids sg-09d49bfded4fb60e0
...
sudo mount -t nfs4 -o nfsvers=4.1,rsize=1048576,wsize=1048576,hard,timeo=600,retrans=2,noresvport fs-0a6532889de58419d.efs.us-east-1.amazonaws.com:/ ~/efs-mount-point
...
sudo mount -t efs -o tls fs-0a6532889de58419d.efs.us-east-1.amazonaws.com:/ ~/efs-mount-point